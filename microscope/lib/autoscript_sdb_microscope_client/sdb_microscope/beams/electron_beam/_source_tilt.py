...
class SourceTilt(object):    
    ...
    def __init__(self, application_client):
        ...
        self.__id = "SdbMicroscope.Beams.ElectronBeam.SourceTilt"
    ...
    def limits(self) -> 'Limits2d':        
        ...
        if call_response.result.data_type != DataTypeDefinition(DataType.STRUCTURE_PRIMARY_ID, secondary_id="Limits2d"):
            raise TypeError("Incompatible type: source_tilt.limits was expecting Limits2d, but server returned different object type: " + repr(call_response.result.data_type))
    ...
    def value(self) -> 'Point':        
        ...
        if call_response.result.data_type != DataTypeDefinition(DataType.STRUCTURE_PRIMARY_ID, secondary_id="Point"):
            raise TypeError("Incompatible type: source_tilt.value was expecting Point, but server returned different object type: " + repr(call_response.result.data_type))
