...
class GridVoltage(object):    
    ...
    def __init__(self, application_client):
        ...
        self.__id = "SdbMicroscope.Detector.CustomSettings.GridVoltage"


    @property
    def value(self) -> 'float':        
        """
        Gets or sets the value of the detector grid voltage.
        """
        ...
        if call_response.result.data_type != DataType.DOUBLE:
            raise TypeError("Incompatible type: grid_voltage.value was expecting float, but server returned different object type: " + repr(call_response.result.data_type))
