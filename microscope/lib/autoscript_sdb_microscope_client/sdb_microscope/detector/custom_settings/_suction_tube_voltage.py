...
class SuctionTubeVoltage(object):
    ...
    def __init__(self, application_client):
        ...
        self.__id = "SdbMicroscope.Detector.CustomSettings.SuctionTubeVoltage"
    ...
    def value(self) -> 'float':
        ...
        if call_response.result.data_type != DataType.DOUBLE:
            raise TypeError("Incompatible type: suction_tube_voltage.value was expecting float, but server returned different object type: " + repr(call_response.result.data_type))
