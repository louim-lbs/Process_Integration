...
class CrossoverZoom(object):
    ...
    def __init__(self, application_client):
        ...
        self.__id = "SdbMicroscope.Beams.ElectronBeam.CrossoverZoom"
    ...
    def limits(self) -> 'Limits':
        ...
        if call_response.result.data_type != DataTypeDefinition(DataType.STRUCTURE_PRIMARY_ID, secondary_id="Limits"):
            raise TypeError("Incompatible type: crossover_zoom.limits was expecting Limits, but server returned different object type: " + repr(call_response.result.data_type))
    ...
    def value(self) -> 'float':
        ...
        if call_response.result.data_type != DataType.DOUBLE:
            raise TypeError("Incompatible type: crossover_zoom.value was expecting float, but server returned different object type: " + repr(call_response.result.data_type))
