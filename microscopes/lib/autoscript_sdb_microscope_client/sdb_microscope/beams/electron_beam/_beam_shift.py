...
class BeamShift(object):
    ...
    def __init__(self, application_client):
        ...
        self.__id = "SdbMicroscope.Beams.ElectronBeam.BeamShift"
    ...
    def limits(self) -> 'Limits2d':
        ...
        if call_response.result.data_type != DataTypeDefinition(DataType.STRUCTURE_PRIMARY_ID, secondary_id="Limits2d"):
            raise TypeError("Incompatible type: beam_shift.limits was expecting Limits2d, but server returned different object type: " + repr(call_response.result.data_type))
    ...
    def value(self) -> 'Point':
        ...
        if call_response.result.data_type != DataTypeDefinition(DataType.STRUCTURE_PRIMARY_ID, secondary_id="Point"):
            raise TypeError("Incompatible type: beam_shift.value was expecting Point, but server returned different object type: " + repr(call_response.result.data_type))
