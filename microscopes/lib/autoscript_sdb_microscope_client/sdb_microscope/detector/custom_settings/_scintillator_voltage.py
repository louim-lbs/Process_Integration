...
class ScintillatorVoltage(object):
    """
    ...
    def __init__(self, application_client):
        ...
        self.__id = "SdbMicroscope.Detector.CustomSettings.ScintillatorVoltage"


    @property
    def value(self) -> 'float':
        """
        Gets or sets the value of the detector scintillator voltage.
        """
        ...
        if call_response.result.data_type != DataType.DOUBLE:
            raise TypeError("Incompatible type: scintillator_voltage.value was expecting float, but server returned different object type: " + repr(call_response.result.data_type))
